        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($cart_items as $item)
                                <tr data-id="{{ $item->productSku->id }}">
                                    ...
                                    <td>
                                        <input type="text" class="form-control input-sm amount" @if(!$item->productSku->product->on_sale) disabled @endif name="amount"
                                               value="{{ $item->amount }}">
                                    </td>
                                    <td>
                    ...
                    @else
                        <h2 class="text-center">购物车为空，请<a href="{{route('products.index')}}">选购</a></h2>
                    @endif
                </div>
            </div>
        </div>
...
// 监听 全选/取消全选 单选框的变更事件
            ...
            $('.btn-create-order').click(function () {
                ...
                var req = {
                    ...
                    coupon_code:$.trim($('input[name=coupon_code]').val()),
                };
